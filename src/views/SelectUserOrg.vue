        ...
        >
          <template #header>
            ...
            ><defs><linearGradient
              ...
              y1="-66.581"
              y2="-57.054"
              gradientTransform="matrix(1.4363 0 0 1.2115 -36.593 193.54)"
            ...
            /><feComposite
              ...
              in2="comp1"
              result="comp2"
            /></filter></defs><g transform="matrix(3.1505 0 0 3.1505 -328.72 -363.41)"><g><rect
              x="104.34"
              y="115.35"
              width="37.676"
              height="13.134"
            ...
            /><g
              transform="matrix(.2088 0 0 .2088 118.13 -92.84)"
              filter="url(#b)"
            ><path
              d="m24 1005.5c-9.806 0-17.75 7.9753-17.75 17.781s7.944 17.75 17.75 17.75c8.6891 0 15.903-6.2558 17.438-14.5h-19.531v4.1562h12.531c-2.324 3.2653-6.1212 5.4063-10.438 5.4063-7.0879 0-12.844-5.7246-12.844-12.812 0-7.088 5.7558-12.844 12.844-12.844 4.6014 0 8.6409 2.4243 10.906 6.0625h5.4688c-2.6656-6.4427-8.9751-11-16.375-11zm-2.0938 14.438v4.2188h19.781c0.14391-1.4074-0.04454-2.968-0.28125-4.2188z"
              fill="#ff7f2a"
            /><g
              fill="#000080"
              stroke="#fff"
            ><g stroke-width=".21049"><rect
              x="1.4006"
              y="1042.4"
              width="2.901"
              height="2.901"
